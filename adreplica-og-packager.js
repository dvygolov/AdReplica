...
function buildLandingHtml({ appName, displayName = appName, build, bookmarklet, manifestUrl, screenshotUrl, iconUrl }) {
  ...
  return [
    ...
    "          <div class=\"install\">",
    `            <a class="bookmarklet" id="bookmarkletLink" href="${escapeHtml(bookmarklet)}">AdReplica</a>`,
    ...
    "      <div class=\"step\"><b>1. Install</b>Drag the AdReplica button to your bookmarks bar, or use Copy to clipboard and paste the loader into a bookmark URL.</div>",
    ...
    "    </section>",
    "    <p class=\"footer\">by <a href=\"https://yellowweb.top\" target=\"_blank\" rel=\"noopener\">Yellow Web</a> · <a href=\"https://t.me/yellow_web\" target=\"_blank\" rel=\"noopener\">Telegram</a>. The loader checks the manifest and loads verified payload chunks through Facebook OG metadata via Graph.</p>",
    "  </main>",
    "  <script>",
